...
class RegisterActivity : AppCompatActivity() {
    ...
    private lateinit var register_progress_bar: ProgressBar
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        register_progress_bar = findViewById<ProgressBar>(R.id.register_progress_bar)
    ...
    fun createNewAcount(){
        ...
        //register_progress_bar = ProgressBar(this)
        //register_progress_bar.setProgress(1,  true)
        ...
        if(firstName.isNullOrEmpty() || lastName.isNullOrEmpty() || email.isNullOrEmpty() || password.isNullOrEmpty() || repeatPassword.isNullOrEmpty()){
            Toast.makeText(this, "Todos los campos son obligatorios, por favor completa el formulario de Nuevo Usuario", Toast.LENGTH_SHORT)
        } else {

            if(password != repeatPassword){
                Toast.makeText(this, "Las contraseñas no coinciden, por favor vuelve a escribirlas", Toast.LENGTH_SHORT)
            } else {
                ...
                nelsAuth!!
                    ...
                    .addOnCompleteListener(this) {task ->
                            ...
                            if(task.isSuccessful){
                                ...
                                currentUserDb.child("Email").setValue(lastName)
                                currentUserDb.child("Contraseña").setValue(lastName)
                                updateUserInfoAndUI()

                            } else {

                                Log.w(TAG, "createUserWithEmail:failure", task.exception)
                                Toast.makeText(this, "Fallo de autonticación, intentalo más tarde.", Toast.LENGTH_SHORT).show()
